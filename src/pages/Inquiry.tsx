...
let initialType = 'Private Ownership';
if (typeParam === 'commercial') initialType = 'Commercial License';
if (typeParam === 'elite') initialType = 'Elite Producer';
...
const options = ['Elite Producer', 'Private Ownership', 'Commercial License', 'General Inquiry'];
